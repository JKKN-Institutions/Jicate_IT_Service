...
/**
 * Closing contact band — "Get Started with Pipeline Builder". A giant heading
 * over a single-column form (text fields, a country select, a message box, and
 * a privacy note), matching the reference's narrow centered form rail.
 */
export function GetStarted() {
  return (
    <Section className="!pt-0 !pb-[100px]" aria-label="Get Started with Pipeline Builder">
      <Container>
