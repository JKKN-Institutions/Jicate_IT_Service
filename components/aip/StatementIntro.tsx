...
import { statementIntro } from "@/content/aip";
...
export function StatementIntro() {
  return (
    <section className="bg-canvas py-[120px] desktop:py-[150px]">
      <Container>
        <Reveal>
          <h2 className="mx-auto max-w-[14ch] whitespace-pre-line text-center font-display text-[clamp(2.5rem,6vw,4.5rem)] font-normal leading-[1] tracking-[-0.04em] text-ink">
            {statementIntro.text}
          </h2>
        </Reveal>
      </Container>
