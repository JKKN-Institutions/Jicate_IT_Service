...
import { contact } from "@/content/streaming";
...
/**
 * "Get Started with the Ontology" — a light lead-capture form. Giant heading on
 * the left, single-column full-width fields on the right. Static UI; no
 * submission wiring.
 */
