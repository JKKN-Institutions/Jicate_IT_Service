...
import { hero } from "@/content/dynamic-scheduling";

import { GiantHeading } from "./parts";

/**
 * Hero — two-column split (reference parity): oversized title fills the left
 * rail; a short lead paragraph sits top-right.
 */
export function DsHero() {
  return (
    <Section className="!pb-[60px] !pt-[80px] desktop:!pt-[100px]" aria-label="Foundry Dynamic Scheduling">
      <Container>
        <Reveal className="grid items-start gap-l desktop:grid-cols-[1fr_420px] desktop:gap-[60px]">
          ...
          <p className="max-w-[36ch] text-body-lg leading-[1.4] text-ink desktop:pt-[10px]">
            {hero.body}
          </p>
        </Reveal>
      </Container>
