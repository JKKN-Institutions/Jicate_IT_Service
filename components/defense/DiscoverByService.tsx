...
import { GiantHeading, SubHeading } from "./parts";
          ...
          <div className="flex flex-col">
            ...
            <ul className="mt-[40px] flex flex-col">
              {discover.services.map((s) => (
                <li key={s.label}>
                  <div className="flex items-center justify-between border-b border-white/20 py-[20px] text-[clamp(1.25rem,1.6vw,1.5rem)] text-white/80">
                    <span>{s.label}</span>
                  </div>
                </li>
              ))}
