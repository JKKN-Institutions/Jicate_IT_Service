...
/**
 * Light-theme heading helpers for the Supply Chain page (ink text on white).
...
/** Inked underlined arrowed link (↳ label). */
export function LeadLink({ href, children, className }: { href: string; children: ReactNode; className?: string }) {
  return (
    <a
      href={href}
      className={cn(
