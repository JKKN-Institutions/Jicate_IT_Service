...
import { contact } from "@/content/energy";
...
/**
 * "Get in Touch" — a light lead-capture form. Giant heading on the left,
 * single-column full-width fields on the right. Asterisk before label. Static UI.
 */
export function ContactForm() {
  return (
    <Section id={contact.id} className="bg-canvas scroll-mt-[160px]" aria-label={contact.heading}>
      <Container>
