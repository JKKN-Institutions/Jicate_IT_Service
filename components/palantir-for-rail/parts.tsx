...
/**
 * Light-theme heading helpers for the Palantir-for-Rail page (ink text on
 * white). Line-height is baked into the size token so tailwind-merge can't strip
 * a standalone `leading-*` class.
 */
