...
export function SiteHeader() {
  ...
  return (
    ...
    >
      {/* Transparent over the dark hero media (white content), crossfading to a
          solid surface-light bar with a hairline underline once the hero
          scrolls away. Sharp corners, no float, no blur. */}
      <nav
        aria-label="Primary"
        className={cn(
