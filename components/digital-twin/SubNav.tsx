...
import { subNav } from "@/content/digital-twin";

/**
 * Sticky product sub-nav for the digital-twin page. Brand link, a set of
 * section links (with chevron affordance), and a right-aligned CTA. Light band
 * that rides under the site header. Server Component.
 */
