...
import { contact } from "@/content/anti-money-laundering";
...
/**
 * "Get more out of your data platforms" — a light lead-capture form. Giant
 * heading on the left, single-column full-width fields on the right. Static UI.
 */
