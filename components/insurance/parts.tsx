...
/** Black rounded-square icon with a "↗" glyph — used on feature rows. */
export function FeatureIcon() {
  return (
    <span className="flex size-[50px] shrink-0 items-center justify-center rounded-[15px] bg-[#1e2124] text-canvas">
      <svg aria-hidden viewBox="0 0 24 24" className="size-[22px]" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
