...
import { hero } from "@/content/insurance";

import { GiantHeading } from "./parts";

/**
 * Hero — a full-bleed building image, then a dark title band with a giant white
 * title and a muted subcopy beneath.
 */
    ...
    <section aria-label={hero.title}>
      ...
      <Section className="bg-[#1e2124]">
        <Container>
          ...
          <p className="mt-l text-[clamp(1.5rem,1rem+2vw,2.556rem)] leading-[1.2] text-[#b9b9b9]">
            {hero.subcopy}
          </p>
        </Container>
      </Section>
