...
export const industries = {
  ...
  items: [
    { label: "Aerospace & Aviation", href: "/offerings" },
    { label: "Automotive", href: "/automotive-mobility" },
    { label: "Construction & Real Estate", href: "/construction" },
    { label: "Energy & Renewables", href: "/energy" },
    { label: "Financial Services & Banking", href: "/financial-services" },
    { label: "Government & Security", href: "/defense" },
    { label: "Healthcare & Life Sciences", href: "/life-sciences" },
    { label: "Insurance", href: "/insurance" },
    { label: "Logistics", href: "/supply-chain" },
    { label: "Manufacturing & Industrials", href: "/offerings" },
    { label: "Media & Telecommunication", href: "/telecommunications" },
    { label: "Retail & Consumer Goods", href: "/retail" },
    { label: "Utilities & Chemicals", href: "/utilities" },
  ],
};
